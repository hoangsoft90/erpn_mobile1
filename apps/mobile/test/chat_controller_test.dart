...
void main() {
  ...
  group('TTS', () {
    ...
    test('identifier-shaped tokens and markup never reach the engine',
      ...
      expect(spoken, contains('Nguyễn Thị Lan'),
          reason: 'the human summary still gets read');
      expect(spoken, contains('100.000đ'));
    ...
    testWidgets(
      ...
      expect(tts.spoken, isNotEmpty,
          reason: 'the proposal summary is announced out loud');
      expect(
