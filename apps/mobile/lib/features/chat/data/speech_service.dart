...
class SystemSpeechService implements SpeechService {
  ...
  Future<void> _startListening(
    ...
    String? localeId,
      ...
      _speech.listen(
        onResult: onResult,
        // P5-4 (plan5_final §6): both timers live in AppConstants so the
        // voice-first layout tunes ONE place — they used to be literals here,
        // invisible from anywhere else. A shop-counter utterance is short; a
        // long open mic just burns battery (and, since P5-4, risks recording
        // an unrelated conversation — review2 §4.2).
        listenOptions: SpeechListenOptions(
          localeId: localeId,
          listenFor: AppConstants.voiceMaxRecordDuration,
          pauseFor: AppConstants.voiceSilenceTimeout,
        ),
      );
