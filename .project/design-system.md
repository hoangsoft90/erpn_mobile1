...
- Chọn chế độ gửi (`Chat thường` / `Phân tích bằng AI`): `SegmentedButton` ngay trên ô nhập —
  không dialog, không persist; đổi chế độ không phải thao tác nguy hiểm nên không cần xác nhận
