...
export const READ_ONLY_TOOLS = Object.freeze([
  ...
  "erpnext_item_list",
  "erpnext_item_get",
  // B1: the supplier resolver (READ only). Deliberately the LIST tool only —
  // supplier_get is not needed to pick a supplier, so it stays out of the
  // whitelist until a caller proves it needs it. erpnext_supplier_create is a
  // write verb and stays refused by the guard below.
