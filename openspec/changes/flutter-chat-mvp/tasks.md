...
- [x] 6.8 **P1 phases2** (entity 4 trạng thái + candidate picker + immutable snapshot + codes tách + `UNKNOWN→RECONCILING` + business dedup + NLP-down write block) — ✅ kỹ thuật, **CHỜ DUYỆT COMMIT (vùng tiền)**; review vòng 2 fix harness Flutter (`result45.txt`). Suite: Python 60 · Node 172 · Flutter 67 · analyze 0.
